...
AVRDUDE_FLAGS = $(AVRDUDE_BASIC) $(AVRDUDE_NO_VERIFY) $(AVRDUDE_VERBOSE) $(AVRDUDE_ERASE_COUNTER) -B 1.1
...
$(TARGET).elf: $(TARGET).o $(SOBJ)
	$(CC) $(ALL_CFLAGS) $(TARGET).o $(SOBJ) --output $@ $(LDFLAGS)
